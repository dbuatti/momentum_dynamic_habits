...
import { HabitWizardStep4 } from './HabitWizardStep4'; // Import the new component
import { HabitTemplateForm } from './HabitTemplateForm';

export { HabitWizardStep1, HabitWizardStep2, HabitWizardStep3, HabitWizardStep4, HabitTemplateForm };