    ...
    <Card className="border-2 border-primary/10 bg-muted/30 rounded-3xl overflow-hidden">
      <CardContent className="p-6 space-y-6">
        <div className="text-center space-y-4">
          <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tighter">How it Works</h2>
        ...
        <div className="grid gap-4">
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-black text-foreground mb-3 uppercase tracking-tight">Anchor Practices</h3>
          ...
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-black text-foreground mb-3 uppercase tracking-tight">Trial Mode</h3>
              <p className="text-muted-foreground font-medium leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-black text-foreground mb-3 uppercase tracking-tight">Adaptive Growth</h3>
              <p className="text-muted-foreground font-medium leading-relaxed">
