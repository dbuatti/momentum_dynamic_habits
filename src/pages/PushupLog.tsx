...
import { Dumbbell, BarChart3, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto px-4 py-6">
      <div className="w-full space-y-8">
        <PageHeader title="Push-ups Analytics" backLink="/" />
        
        <Card className="rounded-2xl shadow-lg border-4 border-orange-100 overflow-hidden">
          <CardHeader className="p-8 text-center">
            <div className="bg-orange-50 rounded-full w-24 h-24 flex items-center justify-center mb-6 mx-auto">
              <Dumbbell className="w-12 h-12 text-orange-500" />
            </div>
            <CardTitle className="text-2xl font-bold text-orange-700">
              Push-ups Historical Data
            </CardTitle>
          </CardHeader>
          <CardContent className="p-8 pt-0 text-center space-y-4">
            <p className="text-muted-foreground">
              This page will soon display detailed historical data, trends, and insights for your Push-ups habit.
              For daily tracking, please use the main dashboard.
            </p>
            <div className="flex justify-center">
              <Link to="/">
                <Button className="bg-orange-500 hover:bg-orange-600 text-white text-lg py-6 rounded-2xl">
