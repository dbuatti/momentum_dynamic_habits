  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto px-4 py-6">
      <div className="w-full space-y-8">
        <PageHeader title="Kinesiology Analytics" backLink="/" />
        
        <Card className="rounded-2xl shadow-lg border-4 border-habit-green overflow-hidden">
          <CardHeader className="p-8 text-center">
            <div className="bg-green-50 rounded-full w-24 h-24 flex items-center justify-center mb-6 mx-auto">
              <BookOpen className="w-12 h-12 text-green-500" />
            </div>
            <CardTitle className="text-2xl font-bold text-habit-green">
              Kinesiology Historical Data
            </CardTitle>
          </CardHeader>
          <CardContent className="p-8 pt-0 text-center space-y-4">
            <p className="text-muted-foreground">
              This page will soon display detailed historical data, trends, and insights for your Kinesiology Study habit.
              For daily tracking, please use the main dashboard.
            </p>
            <div className="flex justify-center">
              <Link to="/">
                <Button className="bg-habit-green hover:bg-habit-green/90 text-habit-green-foreground text-lg py-6 rounded-2xl">
