...
import { Wind, BarChart3, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto px-4 py-6">
      <div className="w-full space-y-8">
        <PageHeader title="Meditation Analytics" backLink="/" />
        ...
        <Card className="rounded-2xl shadow-lg border-4 border-habit-blue overflow-hidden">
          <CardHeader className="p-8 text-center">
            ...
            <CardTitle className="text-2xl font-bold text-habit-blue">
              Meditation Historical Data
            </CardTitle>
          </CardHeader>
          <CardContent className="p-8 pt-0 text-center space-y-4">
            <p className="text-muted-foreground">
              This page will soon display detailed historical data, trends, and insights for your Meditation habit.
              For daily tracking, please use the main dashboard.
            </p>
            <div className="flex justify-center">
              <Link to="/">
                <Button className="bg-habit-blue hover:bg-blue-600 text-white text-lg py-6 rounded-2xl">
