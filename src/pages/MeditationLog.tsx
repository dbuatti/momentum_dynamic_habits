...
const MeditationLog = () => {
  ...
  const initialDurationFromState = location.state?.duration || meditationHabit?.adjustedDailyGoal || 1; // Default from dashboard or 1 min
      ...
      <div className="w-full space-y-8">
        ...
        <div className="p-4 bg-accent rounded-md border border-border">
          <p className="text-sm font-medium text-accent-foreground flex items-center justify-center">
            ...
            Completion Prompt: Breathe deep, let go.
          </p>
        </div>
      </div>
    </div>
