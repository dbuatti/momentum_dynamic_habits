...
const iconMap: { [key: string]: React.ElementType } = {
  Star, Flame, Shield, Target, Crown, Zap, Trophy, Sparkles, Mountain, Award, Sun, Moon, Heart
};
...
const Settings = () => {
  ...
  const totalJourneyDays = meditationHabit 
        ...
        <div className="flex justify-center items-baseline space-x-8">
          {pushupHabit && (
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">{pushupHabit.lifetime_progress}</p>
          ...
          {meditationHabit && (
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">{meditationHabit.lifetime_progress}m</p>
