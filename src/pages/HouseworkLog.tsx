...
import { Play, Pause, RotateCcw, Loader2, Home } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="text-center space-y-8 w-full max-w-xs">
        <h1 className="text-4xl font-bold text-habit-red-foreground">House Work</h1>
        
        <div className="space-y-2">
          <Label htmlFor="housework-duration" className="text-lg font-medium text-muted-foreground">Duration (minutes)</Label>
